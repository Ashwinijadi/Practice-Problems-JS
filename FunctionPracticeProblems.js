...
//Program to convert temperature
{
    ...
    let userInput=Math.random();
    let convertedTemp=0;
    switch(userInput){
        case 1: 
            console.log("celsius to fahrenheit conversion");
            let degreeC=prompt("Enter temperature in celsius")
            convertedTemp=convertTemperatureToFahrenheit(degreeC)
            console.log("Temperature in fahrenheit is: "+convertedTemp);
            break;
        case 2:
            console.log("fahrenheit to celsius conversion");
            let degreeF=prompt("Enter temperature in fahrenheit")
            convertedTemp=convertTemperatureToCelsius(degreeF)
